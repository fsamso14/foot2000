...
/**
 * Classe collectant les données pertinentes dans les fichiers Excel appropriés
...
public class CollecteurArbitre {
	 ...
	 * @throws IOException
	 */
	public HashMap<String,String> getNomArbitre_License() throws BiffException, IOException{
	...
	/**
	 * @param catégorie de l'arbitre D1, D2 ...
	 * @return liste des identifiants des arbitres de la catégorie souhaitée
	 * @throws BiffException
	 * @throws IOException
	 */
	public ArrayList<String> getID_ArbitreCat(String cat) throws BiffException, IOException{
