...
public class CollecteurDisponibilitesArbitre implements Collecteur{
	...
	Workbook workbook;
	String adresseFichier = "C:\\Users\\Fab\\Desktop\\FakeTest\\IndisposArbitres.xls";
	...
	public HashMap<String,ArbitreDisponibilite> getData() throws BiffException, IOException {
		...
		for(int i=1;i<sheet.getRows();i++){
				...
				ArbitreDisponibilite ad=new ArbitreDisponibilite(disp[0],disp[1],disp[2],disp[3]);
